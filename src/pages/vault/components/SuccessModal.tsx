...
const EtherscanLinkItem = styled.a({
  alignItems: 'center',
  borderRadius: 4,
...
const EtherscanText = styled.span({
  paddingLeft: 16,
  fontSize: 13,
  fontWeight: 500,
  opacity: 0.95,
...
const EtherscanNormalText = styled.span({
  fontSize: 13,
  fontWeight: 300,
});
  ...
  return (
    ...
    >
      <ModalBody>
        ...
        <EtherscanLinkItem href={`https://etherscan.io/tx/${state.txHash}`}>
          ...
          <EtherscanText><EtherscanNormalText>View on</EtherscanNormalText> Etherscan↗</EtherscanText>
        </EtherscanLinkItem>
      </ModalBody>
    </Modal>
  );
